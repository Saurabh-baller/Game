...
import { LiveIcon } from '../../assets/icons'
      ...
      <div>
        ...
        >
          <div className='h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800'>
            <span
              className='text-white flex w-full flex-row-reverse sm:hidden'
            ...
            <ul className='space-y-2'>
              ...
              <li>
                <a
                  ...
                  className='flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'
                >
                  <LiveIcon className='flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' />
